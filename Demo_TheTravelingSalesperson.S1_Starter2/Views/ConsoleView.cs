...
namespace Demo_TheTravelingSalesperson
{
    ...
    public class ConsoleView
    {
        ...
        {
            ConsoleUtil.HeaderText = "The Traveling Salesperson App";
            ConsoleUtil.DisplayReset();
        ...
        public void DisplayCitiesTraveled(Salesperson salesperson)
        {
            ...
            ConsoleUtil.DisplayMessage($"You began your journey in {salesperson.StartingCity}!");            
        ...
        public void DisplayAccountInfo(Salesperson salesperson)
        {
            ...
            ConsoleUtil.DisplayMessage("Your Starting City: " + salesperson.StartingCity);
